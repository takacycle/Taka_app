...
export default function SignInScreen() {
  ...
  async function handleSendCode() {
    ...
    if (!/^\+\d{9,15}$/.test(normalized)) {
      setError("Enter your full phone number in international format, e.g. +233241234567");
      return;
    }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Takacycle Agent</Text>
      <Text style={styles.subtitle}>Sign in with the phone number your dispatcher registered.</Text>
